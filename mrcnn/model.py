...
from mrcnn.utils import log, mold_image

from mrcnn.backbone import BatchNorm, resnet_graph, compute_backbone_shapes

from mrcnn.loss_functions import rpn_class_loss_graph, rpn_bbox_loss_graph
from mrcnn.loss_functions import mrcnn_class_loss_graph, mrcnn_bbox_loss_graph
...
from mrcnn.rpn import build_rpn_model
...
from mrcnn.detection_traget_layer import DetectionTargetLayer
...
def build_shared_conv_layers(input_image, config):
    """
    https://medium.com/@jonathan_hui/\
    understanding-feature-pyramid-networks-for-object-detection-fpn-45b227b9106c

    Input :  image
    Returns: rpn_feature_maps, mrcnn_feature_maps
    """
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        rpn_feature_maps, mrcnn_feature_maps = build_shared_conv_layers(
            input_image, config)
